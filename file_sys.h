...
class base_file {
   ...
   public:
      ...
      // directory only
      virtual void addEntry(     // mutator
         const string& filename, const inode_ptr node);
      // directory only
      virtual void harakiri();   // mutator
      // directory only          //getter
      virtual inode_ptr find(const string& filename);
      // directory only          // getter
      virtual string find_string(const inode_ptr node);
      // directory only
      virtual void print_dir();
      // directory only
      virtual void megaprint(const string path);
};

// class plain_file -
// Used to hold data.
...
// default ctor -
//    Creates a new map with keys "." and "..". // lies
// remove -
...
//    if the entry already exists. Directory entries are
...
class directory: public base_file {
   ...
   public:
      ...
      virtual string find_string(const inode_ptr node) override;
      virtual void print_dir() override;
      virtual void megaprint(const string path) override;
};
